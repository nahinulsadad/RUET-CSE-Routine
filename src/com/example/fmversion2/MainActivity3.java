...
public class MainActivity3 extends Activity 
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        ArrayList<String> list = one.ctRoutine(2); 
        ...
        TextView odd = new TextView(this);
        odd.setGravity(Gravity.CENTER);
        odd.setText("Cycle\nOdd");   
        odd.setBackgroundResource(R.drawable.cell_shape3);
        odd.setTextSize(35);
        odd.setTextColor(Color.parseColor("#000000"));
     
        ll.addView(odd);
        
        list = one.ctRoutine(1);
	...
	public boolean onOptionsItemSelected(MenuItem item) 
	{
		...
		{
			Intent intent = new Intent(MainActivity3.this, Next_Activity.class);
			intent.putExtra("message", day);
			intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
