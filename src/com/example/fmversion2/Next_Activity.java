...
public class Next_Activity extends ActionBarActivity 
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        ArrayList<String> list = one.wholeDayClassCalculation(); 
	...
	public boolean onOptionsItemSelected(MenuItem item) 
	{
		...
		{
			Intent intent = new Intent(Next_Activity.this, MainActivity4.class);
			intent.putExtra("message", day);
			intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		{
			Intent intent = new Intent(Next_Activity.this, MainActivity3.class);
			intent.putExtra("message", day);
			intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		...
		{
			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Next_Activity.this);
